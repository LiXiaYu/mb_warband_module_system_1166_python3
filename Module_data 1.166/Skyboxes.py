...
def save_skyboxes():
  ...
  for skybox in  skyboxes:
    file.write("{0:s} {1:d} {2:f} {3:f} {4:f} {5:s}\n".format(skybox[0],skybox[1],skybox[2],skybox[3],skybox[4],skybox[5]))
    file.write(" {0:f} {1:f} {2:f} ".format(skybox[6]))
    file.write(" {0:f} {1:f} {2:f} ".format(skybox[7]))
    file.write(" {0:f} {1:f} {2:f} ".format(skybox[8]))
    file.write(" {0:f} {1:d}\n".format(skybox[9]))
  file.close()

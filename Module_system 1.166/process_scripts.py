...
def save_python_header():
  ...
  for i_script in range(len(scripts)):
    file.write("script_{0:s} = {1:d}\n".format(convert_to_identifier(scripts[i_script][0]),i_script))
  file.write("\n\n")
  file.close()
